...
def index(request):
    ...
    curated_extras = [
        ...
        _("delete emails from [sender] from today"),
        _("delete emails from [sender] from yesterday"),
        _("delete emails from [sender] from this week"),
        _("delete emails from [sender] from last week"),
        _("delete emails from [sender] from this month"),
        _("delete emails from [sender] from last month"),
        _("delete emails from [sender] from this year"),
        _("delete emails from [sender] from last year"),
        _("delete emails from today"),
        _("delete emails from yesterday"),
        _("delete emails from this week"),
        _("delete emails from last week"),
        _("delete emails from this month"),
        _("delete emails from last month"),
        _("delete emails from this year"),
        _("delete emails from last year"),
        _("delete emails from [sender] from [duration] ago"),
        _("list archived emails"),
        ...
        _("archive account security emails"),
        ...
        _("delete shipping emails from today"),
        _("delete shipping emails from yesterday"),
        _("delete shipping emails from this week"),
        _("delete shipping emails from last week"),
        _("delete shipping emails from this month"),
        _("delete shipping emails from last month"),
        _("delete shipping emails from this year"),
        _("delete shipping emails from last year"),
        _("delete shipping emails from [duration] ago"),
        _("delete verification codes from today"),
        _("delete verification codes from yesterday"),
        _("delete verification codes from this week"),
        _("delete verification codes from last week"),
        _("delete verification codes from this month"),
        _("delete verification codes from last month"),
        _("delete verification codes from this year"),
        _("delete verification codes from last year"),
        _("delete verification codes from [duration] ago"),
        _("delete account security emails from today"),
        _("delete account security emails from yesterday"),
        _("delete account security emails from this week"),
        _("delete account security emails from last week"),
        _("delete account security emails from this month"),
        _("delete account security emails from last month"),
        _("delete account security emails from this year"),
    ...
    try:
        ...
        if current_lang.startswith('he'):
            # Replace English commands with Hebrew equivalents
            curated_extras = [
                "רשום מיילים מהיום",
                "רשום מיילים מאתמול", 
                "רשום מיילים מהשבוע",
                "רשום מיילים מהשבוע שעבר",
                "רשום מיילים מהחודש",
                "רשום מיילים מהחודש שעבר",
                "רשום מיילים מהשנה",
                "רשום מיילים מהשנה שעברה",
                "רשום מיילים אחרונים",
                "רשום מיילים מ[שולח]",
                "הצג סטטיסטיקות דואל",
                ...
                "רשום מיילים מ[שולח] מהשבוע",
                "רשום מיילים מ[שולח] מהשבוע שעבר",
                "רשום מיילים מ[שולח] מהחודש",
                "רשום מיילים מ[שולח] מהחודש שעבר",
                "רשום מיילים מ[שולח] מהשנה",
                "רשום מיילים מ[שולח] מהשנה שעברה",
                "רשום מיילים מ[שולח] ישנים מ[משך]",
                "רשום מיילי משלוח",
                "רשום מיילי משלוח מ[תקופה]",
                "רשום מיילי משלוח מלפני [משך]",
                "רשום מיילי משלוח ישנים מ[משך]",
                "רשום מיילי קודי אימות",
                "רשום מיילי קודי אימות מ[תקופה]",
                "רשום מיילי קודי אימות מלפני [משך]",
                "רשום מיילי קודי אימות ישנים מ[משך]",
                "רשום מיילי אבטחת חשבון",
                "רשום מיילי אבטחת חשבון מ[תקופה]",
                "רשום מיילי אבטחת חשבון מלפני [משך]",
                "רשום מיילי אבטחת חשבון ישנים מ[משך]",
                "מחק מיילים ישנים מ[משך]",
                "מחק מיילים מלפני [משך]",
                "מחק מיילים מ[שולח] מהיום",
                "מחק מיילים מ[שולח] מאתמול",
                "מחק מיילים מ[שולח] מהשבוע",
                "מחק מיילים מ[שולח] מהשבוע שעבר",
                "מחק מיילים מ[שולח] מהחודש",
                "מחק מיילים מ[שולח] מהחודש שעבר",
                "מחק מיילים מ[שולח] מהשנה",
                "מחק מיילים מ[שולח] מהשנה שעברה",
                "מחק מיילים מהיום",
                "מחק מיילים מאתמול",
                "מחק מיילים מהשבוע",
                "מחק מיילים מהשבוע שעבר",
                "מחק מיילים מהחודש",
                "מחק מיילים מהחודש שעבר",
                "מחק מיילים מהשנה",
                "מחק מיילים מהשנה שעברה",
                "מחק מיילים מ[שולח] מלפני [משך]",
                "מחק מיילים מ[שולח]",
                "מחק מיילים מ[שולח] ישנים מ[משך]",
                "מחק מיילי משלוח",
                "מחק מיילי משלוח ישנים מ[משך]",
                "מחק מיילי קודי אימות",
                "מחק מיילי קודי אימות ישנים מ[משך]",
                "מחק מיילי אבטחת חשבון",
                "מחק מיילי אבטחת חשבון ישנים מ[משך]",
                "מחק מיילי משלוח מהיום",
                "מחק מיילי משלוח מאתמול",
                "מחק מיילי משלוח מהשבוע",
                "מחק מיילי משלוח מהשבוע שעבר",
                "מחק מיילי משלוח מהחודש",
                "מחק מיילי משלוח מהחודש שעבר",
                "מחק מיילי משלוח מהשנה",
                "מחק מיילי משלוח מהשנה שעברה",
                "מחק מיילי משלוח מלפני [משך]",
                "מחק מיילי קודי אימות מהיום",
                "מחק מיילי קודי אימות מאתמול",
                "מחק מיילי קודי אימות מהשבוע",
                "מחק מיילי קודי אימות מהשבוע שעבר",
                "מחק מיילי קודי אימות מהחודש",
                "מחק מיילי קודי אימות מהחודש שעבר",
                "מחק מיילי קודי אימות מהשנה",
                "מחק מיילי קודי אימות מהשנה שעברה",
                "מחק מיילי קודי אימות מלפני [משך]",
                "מחק מיילי אבטחת חשבון מהיום",
                "מחק מיילי אבטחת חשבון מאתמול",
                "מחק מיילי אבטחת חשבון מהשבוע",
                "מחק מיילי אבטחת חשבון מהשבוע שעבר",
                "מחק מיילי אבטחת חשבון מהחודש",
                "מחק מיילי אבטחת חשבון מהחודש שעבר",
                "מחק מיילי אבטחת חשבון מהשנה",
                "מחק מיילי אבטחת חשבון מהשנה שעברה",
                "מחק מיילי אבטחת חשבון מלפני [משך]",
                "ארכב מיילים מ[שולח]",
                "ארכב מיילים מ[שולח] ישנים מ[משך]",
                "ארכב מיילים מ[שולח] מלפני [משך]",
                "ארכב מיילים מ[שולח] מהיום",
                "ארכב מיילים מ[שולח] מאתמול",
                "ארכב מיילים מ[שולח] מהשבוע",
                "ארכב מיילים מ[שולח] מהשבוע שעבר",
                "ארכב מיילים מ[שולח] מהחודש",
                ...
                "ארכב מיילי קודי אימות ישנים מ[משך]",
                "ארכב מיילי אבטחת חשבון",
                "ארכב מיילי אבטחת חשבון ישנים מ[משך]",
                "ארכב מיילים ישנים מ[משך]",
                "שחזר מיילים מ[שולח]",
                "צור תווית \"[תווית]\"",
...
def _translate_hebrew_command_to_english(command: str) -> str:
    ...
    replacements = [
        ...
        # Archive category forms (DUAL): "ארכב מיילי <קטגוריה> מלפני חודשיים/שבועיים/שנתיים/יומיים" -> "archive <category> from 2 <unit> ago"
        (r"^[\s]*ארכב\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מלפני\s*(חודשיים|שבועיים|שנתיים|יומיים)",
         lambda m: f"archive {_cat_key_to_en(m.group(1) or '')} from 2 {_he_to_en_unit(m.group(2), 2)} ago"),
        ...
        # Delete sender forms: "מחק מיילים מ[שולח] מלפני N יחידה" -> "delete emails from [sender] from N <unit> ago"
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מלפני\s*(\d+)\s*(יום(?:ים)?|שבוע(?:ות)?|חודש(?:ים)?|שנה(?:ים)?)",
         lambda m: f"delete emails from {m.group(1).strip()} from {m.group(2)} {_he_to_en_unit(m.group(3), int(m.group(2)))} ago"),
        # Delete sender forms: "מחק מיילים מ[שולח] מלפני חודשיים/שבועיים/שנתיים/יומיים" -> "delete emails from [sender] from 2 <unit> ago"
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מלפני\s*(חודשיים|שבועיים|שנתיים|יומיים)",
         lambda m: f"delete emails from {m.group(1).strip()} from 2 {_he_to_en_unit(m.group(2), 2)} ago"),
        # Delete sender forms: "מחק מיילים מ[שולח] מלפני יחידה" (without number, assume 1)
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מלפני\s*(יום|שבוע|חודש|שנה)",
         lambda m: f"delete emails from {m.group(1).strip()} from 1 {_he_to_en_unit(m.group(2), 1)} ago"),
        ...
        # Delete sender fixed timeframes: מחק מיילים מ[sender] מהיום/מאתמול/מהשבוע/מהחודש/מהשנה/…שעבר(ה)
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהיום", lambda m: f"delete emails from {m.group(1).strip()} from today"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מאתמול", lambda m: f"delete emails from {m.group(1).strip()} from yesterday"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהשבוע\s+שעבר", lambda m: f"delete emails from {m.group(1).strip()} from last week"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהשבוע", lambda m: f"delete emails from {m.group(1).strip()} from this week"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהחודש\s+שעבר", lambda m: f"delete emails from {m.group(1).strip()} from last month"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהחודש", lambda m: f"delete emails from {m.group(1).strip()} from this month"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהשנה\s+שעברה", lambda m: f"delete emails from {m.group(1).strip()} from last year"),
        (r"^[\s]*מחק\s+מיילים\s+מ-?\s*([A-Za-z0-9_.+\-@\u0590-\u05FF]+)\s+מהשנה", lambda m: f"delete emails from {m.group(1).strip()} from this year"),
        # Delete category fixed timeframes: מחק מיילי <category> מהיום/מאתמול/מהשבוע/מהחודש/מהשנה/…שעבר(ה)
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהיום", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from today"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מאתמול", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from yesterday"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהשבוע\s+שעבר", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from last week"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהשבוע", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from this week"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהחודש\s+שעבר", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from last month"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהחודש", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from this month"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהשנה\s+שעברה", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from last year"),
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מהשנה", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from this year"),
        # Delete category from duration ago: מחק מיילי <category> מלפני N יחידה
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מלפני\s*(\d+)\s*(יום(?:ים)?|שבוע(?:ות)?|חודש(?:ים)?|שנה(?:ים)?)", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from {int(m.group(2))} {_he_to_en_unit(m.group(3), int(m.group(2)))} ago"),
        # Delete category from duration ago: מחק מיילי <category> מלפני חודשיים/שבועיים/שנתיים/יומיים
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מלפני\s*(חודשיים|שבועיים|שנתיים|יומיים)", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from 2 {_he_to_en_unit(m.group(2), 2)} ago"),
        # Delete category from duration ago: מחק מיילי <category> מלפני יחידה (assume 1)
        (r"^[\s]*מחק\s+מיילי(?:ם)?\s+([\u0590-\u05FF\s]+?)\s+מלפני\s*(יום|שבוע|חודש|שנה)", lambda m: f"delete {_cat_key_to_en(m.group(1) or '')} from 1 {_he_to_en_unit(m.group(2), 1)} ago"),
